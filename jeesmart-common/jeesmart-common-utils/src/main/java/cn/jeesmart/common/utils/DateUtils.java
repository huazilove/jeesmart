...
public class DateUtils {
	...
	public static float getSecondsByCompare(Date preDatetime,Date afterDatetime){ 
		...
		String preTime = df.format(preDatetime);
		String afterTime = df.format(afterDatetime);
		return getSecondsByCompare(preTime,afterTime);
	}
	...
	public static String dayBeforeToday(int days) {
		Calendar calendar = Calendar.getInstance();
		// 24小时制，而calendar.set(Calendar.HOUR,0);则是12小时制
